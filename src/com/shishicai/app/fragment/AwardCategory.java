...
public class AwardCategory extends Fragment implements PullToRefreshView.OnHeaderRefreshListener, PullToRefreshView.OnFooterRefreshListener, OnPageChangeListener, View.OnClickListener {
    ...
    private List<PKshiInfo.ItemsBean> list1;
    ...
    public void onHeaderRefresh(PullToRefreshView view) {
        switch (index) {
            ...
            case 1:
                msgLayout1.setVisibility(View.GONE);
    ...
    private void gainData() {
        ...
        HttpUser.get(url, new AsyncHttpResponseHandler(){
            ...
            public void onSuccess(int arg0, Header[] arg1,
                ...
                PKshiInfo info;
                try {
                    info = GsonUtils.parseJSON(str, PKshiInfo.class);
    ...
    public void gainData(String day) {
        ...
        String url = Constant.AWARD_URL;
        LogUtil.e(TAG, "day=" + day);
        long diff = 0l;
        SimpleDateFormat ft = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        try {
            Date sDate = ft.parse(day + " 12:00:00");
            diff = sDate.getTime();
        } catch (ParseException e) {
            e.printStackTrace();
        }
        diff = diff / 1000;
        url = url + "&timestamp=" + diff;
        LogUtil.e(TAG, "url=" + url);
        HttpUser.get(url, new AsyncHttpResponseHandler(){
