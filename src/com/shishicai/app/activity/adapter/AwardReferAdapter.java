...
public class AwardReferAdapter extends BaseAdapter {
	...
	private List<AwardReferInfo.ItemsBean> list;
	private ReferListAdapter adapter;

	public AwardReferAdapter(Context context, List<AwardReferInfo.ItemsBean> list)
	{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		AwardReferInfo.ItemsBean bean = list.get(position);
		timeTv.setText(bean.getDate());
		expertTv.setText(bean.getPeriod() + "期");
		if (TextUtils.equals(bean.getResult(), "等待开奖"))
		{
			resultTv.setText("投注参考");
		}else
		{
			resultTv.setText("开奖结果:" + bean.getResult());
		}
